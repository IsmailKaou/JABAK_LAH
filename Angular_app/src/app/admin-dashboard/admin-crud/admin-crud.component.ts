...
export class AdminCrudComponent  {
  ...
  this.http
    ...
    this.agents = Array.from(agentsXml).map(agentXml => {
      return {
        id :agentXml.getElementsByTagName('ns2:agentId')[0].textContent,
        firstName: agentXml.getElementsByTagName('ns2:firstName')[0].textContent,
        lastName: agentXml.getElementsByTagName('ns2:lastName')[0].textContent,
        phone: agentXml.getElementsByTagName('ns2:phone')[0].textContent,
        email: agentXml.getElementsByTagName('ns2:email')[0].textContent,
        immatriculation: agentXml.getElementsByTagName('ns2:immatriculation')[0].textContent,
        addresse: agentXml.getElementsByTagName('ns2:addresse')[0].textContent,
        license: agentXml.getElementsByTagName('ns2:license')[0].textContent,
        cin: agentXml.getElementsByTagName('ns2:cin')[0].textContent,
        cinPicture: agentXml.getElementsByTagName('ns2:cinPicture')[0].textContent,
        birthday: agentXml.getElementsByTagName('ns2:birthday')[0].textContent
