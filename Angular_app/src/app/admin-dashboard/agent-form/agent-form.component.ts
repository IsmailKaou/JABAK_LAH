...
const bd  = new Date(this.data.agent.birthday)
      this.updateAgentform = new FormGroup({
        ...
        addresse: new FormControl(this.data.agent.addresse,Validators.required),
        license: new FormControl(this.data.agent.license,Validators.required),
        phone: new FormControl(this.data.agent.phone,[Validators.required,Validators.pattern(
          '^[+]?[(]?[0-9]{3}[)]?[-s.]?[0-9]{3}[-s.]?[0-9]{4,6}$'
        )]),
        immatriculation: new FormControl(this.data.agent.immatriculation,Validators.required),
        email: new FormControl(this.data.agent.email,[Validators.email,Validators.required]),
        confirmationEmail:new FormControl(this.data.agent.email,Validators.email),
        birthday: new FormControl(
          this.data.agent.birthday,Validators.required),
